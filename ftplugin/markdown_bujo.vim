...
nnoremap <expr> <silent> <buffer> <Plug>BujoChecknormal <SID>SearchCheck() ? ':keeppatterns s/\[\]/\[x\]<Enter>' : ':keeppatterns s/\[x\]/\[\]<Enter>'
nnoremap <silent> <buffer> <Plug>BujoAddnormal i-[]
inoremap <silent> <buffer> <Plug>BujoAddinsert -[]
inoremap <expr> <silent> <buffer> <Plug>BujoCheckinsert <SID>SearchCheck() ? '<esc>:keeppatterns s/\[\]/\[x\]<Enter>' : '<esc>:keeppatterns s/\[x\]/\[\]<Enter>'
